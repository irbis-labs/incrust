...
mod tests {
    ...
    fn good(sample: &str) {
        ...
        assert_eq!(
            Ok((Slice(EMPTY), pst::Node::CharLiteral(&sample[1..sample.len() - 1]))),
            char_literal(sample),
        );
    }
